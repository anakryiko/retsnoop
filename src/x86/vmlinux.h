...
struct x86_hw_tss {
	short unsigned int back_link;
	short unsigned int __blh;
	long unsigned int sp0;
	short unsigned int ss0;
	short unsigned int __ss0h;
	long unsigned int sp1;
	short unsigned int ss1;
	short unsigned int __ss1h;
	long unsigned int sp2;
	short unsigned int ss2;
	short unsigned int __ss2h;
	long unsigned int __cr3;
	long unsigned int ip;
	long unsigned int flags;
	long unsigned int ax;
	long unsigned int cx;
	...
	short unsigned int gs;
	short unsigned int __gsh;
	short unsigned int ldt;
	short unsigned int __ldth;
	short unsigned int trace;
...
struct x86_io_bitmap {
	...
	long unsigned int bitmap[2049];
	long unsigned int mapall[2049];
};
...
struct kvm_pmu {
	...
	long unsigned int reprogram_pmi[2];
	long unsigned int all_valid_pmc_idx[2];
	long unsigned int pmc_in_use[2];
	u64 ds_area;
	u64 pebs_enable;
...
struct kvm_vcpu_arch {
	...
	long unsigned int ioapic_handled_vectors[8];
...
struct kvm_xen {
	...
	long unsigned int poll_mask[32];
};
...
enum kvm_reg {
	...
	VCPU_EXREG_CR3 = 11,
	VCPU_EXREG_CR4 = 12,
	VCPU_EXREG_RFLAGS = 13,
	VCPU_EXREG_SEGMENTS = 14,
	VCPU_EXREG_EXIT_INFO_1 = 15,
	VCPU_EXREG_EXIT_INFO_2 = 16,
};
...
struct kvm_vcpu_hv_synic {
	...
	long unsigned int auto_eoi_bitmap[8];
	long unsigned int vec_bitmap[8];
	bool active;
...
struct cpu_hw_events {
	...
	long unsigned int active_mask[2];
	long unsigned int dirty[2];
	int enabled;
	int n_events;
	int n_added;
	int n_txn;
